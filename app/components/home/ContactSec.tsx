...
export function ContactSec({ phase, mob, agreed, setAgreed }: ContactSectionProps) {
    const [agreedLocal, setAgreedLocal] = useState(agreed);

    const handleAgree = () => {
        const newValue = !agreedLocal;
        setAgreedLocal(newValue);
        setAgreed(newValue);
    };

    if (phase !== 'contact') return null;
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', gap: '5px' }}>
                                ...
                                >
                                    ...
                                    <span
                                        style={{ color: 'rgba(255,255,255,0.28)', fontSize: '8px' }}
                                    >
                                        ▾
                                    </span>
                                </div>
                    ...
                    >
                        <div
                            style={{
                                ...
                                background: agreedLocal ? 'rgba(90,40,210,0.85)' : 'transparent',
                                display: 'flex',
                                alignItems: 'center',
                        ...
                        >
                            I agree to the{' '}
                            <span style={{ color: 'rgba(140,100,250,0.95)', cursor: 'pointer' }}>
                                Privacy Policy
                            </span>
                        </span>
                    </div>
