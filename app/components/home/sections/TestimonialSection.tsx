...
// Fallback data - Supabase fail হলে এটা দেখাবে
...
export function TestimonialSection({ cardsIn, mob }: Props) {
    const { testimonials: supabaseData, loading, error } = useTestimonials();
    ...
    useEffect(() => {
        if (total > 0 && activeIdx >= total) {
            setActiveIdx(Math.min(2, total - 1));
        }
    }, [total, activeIdx]);

    useEffect(() => {
        if (!cardsIn || total === 0) return;
            ...
            {[0, 1, 2].map((i) => (
                <div
                    ...
                    style={{
                        ...
                        borderRadius: '20px',
                        background:
                            'linear-gradient(135deg, rgba(60,25,120,0.2), rgba(20,10,40,0.4))',
                        border: '1px solid rgba(105,62,205,0.2)',
                        display: 'flex',
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {error && !loading && supabaseData.length === 0 && (
                        <div
                            style={{
                                textAlign: 'center',
                                padding: '12px',
                                                ...
                                                {isActive && (
                                                    <div
                                                        style={{
                                                            ...
                                                            animation:
                                                                'tstFloat 2.6s ease-in-out infinite',
                                                        }}
                                                    >
                                                        <svg
                                                            width="18"
