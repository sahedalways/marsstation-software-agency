        ...
        <html lang="en" dir="ltr" suppressHydrationWarning>
            ...
            <body className="antialiased">
                <PreloaderProvider>
                    ...
                    <a
                        href="#main-content"
                        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[9999] focus:rounded-md focus:bg-white focus:px-4 focus:py-2 focus:text-black focus:shadow-lg"
                    >
